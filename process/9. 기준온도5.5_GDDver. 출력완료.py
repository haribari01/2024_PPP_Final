...
def main():
    ...
    for year in range(start_year, end_year + 1):
        flowering_date = gdd_ver1(tgdd, dates, ref_temp, threshold, year)
        if flowering_date:
            print(f"{year}년 2월 1일부터 GDD가 106.2를 넘는 날짜는 {flowering_date}입니다.")
        else:
            print(f"{year}년 2월 1일부터 GDD가 106.2를 넘는 날짜는 없습니다.")
