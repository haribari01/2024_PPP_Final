...
def main():
    ...
    for year in range(start_year, end_year + 1):
        flowering_date = degree_600(tmax, dates, threshold, year)
        if flowering_date:
            print(f"{year}년 2월 1일부터 누적 최고기온이 600을 넘는 날짜는 {flowering_date}입니다.")
        else:
            print(f"{year}년 2월 1일부터 누적 최고기온이 600을 넘는 날짜는 없습니다.")
